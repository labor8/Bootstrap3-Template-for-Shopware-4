...
{foreach $sEmotions as $emotion}
    ...
    <!-- <div class="emotion-listing emotion-col{$emotion.grid.cols} emotion-{$emotion@index}"> -->
    <section>
        <div class="row">
            <div class="col-sm-12">
                <h4 class="text-center">{$emotion.name}</h4>
            </div>
        </div>
        {if $emotion.elements.0}
            {foreach $emotion.elements as $element}
                ...
                {if $emotion.grid.cols == 12}
                    {$colWidth = $colWidth  }
                {elseif $emotion.grid.cols == 4}
                    {$colWidth = $colWidth * 3 }
                {elseif $emotion.grid.cols == 3}
                    {if $colWidth == 1}
                    {$colWidth = 4 }
                    {elseif $colWidth == 2}
                    {$colWidth = 8 }
                ...
                <!-- <div class="emotion-element emotion-element-{$emotion@index}-{$element@index} col{$colWidth} row{$colHeight}"> -->
